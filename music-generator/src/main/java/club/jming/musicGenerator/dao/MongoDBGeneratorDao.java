package club.jming.musicGenerator.dao;

import club.jming.musicGenerator.adaptor.MongoTableInfoAdaptor;
import club.jming.musicGenerator.config.MongoCondition;
import club.jming.musicGenerator.config.MongoManager;
import club.jming.musicGenerator.entity.mongo.MongoDefinition;
import club.jming.musicGenerator.factory.MongoDBCollectionFactory;
import club.jming.musicGenerator.utils.MongoScanner;
